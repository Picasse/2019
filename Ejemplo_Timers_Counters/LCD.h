...
#define LCD_PRT_0 GPIOF
#define LCD_PRT_1 GPIOF
#define LCD_PRT_2 GPIOF
#define LCD_PRT_3 GPIOF
#define LCD_PRT_4 GPIOF
#define LCD_PRT_5 GPIOF
#define LCD_PRT_6 GPIOF
#define LCD_PRT_7 GPIOF
// constantes para los pines de E RS y RW
#define LCD_PIN_E 8
#define LCD_PIN_RS 9
#define LCD_PIN_RW 10
// constantes para los puertos de E RS y RW
#define LCD_PRT_E GPIOF
#define LCD_PRT_RS GPIOF
#define LCD_PRT_RW GPIOF
